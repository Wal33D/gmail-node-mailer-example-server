    ...
    <html lang="en">
      <head>
        ...
        <style>
          ...
          .container { max-width: 800px; margin: auto; background-color: #ffffff; border-radius: 10px; overflow: hidden; box-shadow: 0 6px 20px rgba(0,0,0,0.15); }
...
const gmailServiceAccountOrPath = process.env.GMAIL_MAILER_SERVICE_ACCOUNT ? 
    JSON.parse(process.env.GMAIL_MAILER_SERVICE_ACCOUNT) : 
    process.env.GMAIL_MAILER_SERVICE_ACCOUNT_PATH;

const gmailMailer = 
new GmailMailer(gmailSenderEmail, gmailServiceAccountOrPath);
</pre>
...
console.log(response);</pre>
    ...
    gmailResponse: {/* Gmail Response Object */}
          ...
          <div class="footer">
            <p>github <a href="https://github.com/our-node-packages/gmail-node-mailer">gmail-node-mailer</a></p>
          </div>
        </div>
      </body>
    </html>
